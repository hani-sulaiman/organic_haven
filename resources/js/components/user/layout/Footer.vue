                    ...
                    <div class="col-lg-12">
                        <div class="position-relative newsletter-inner">
                            <div class="newsletter-content">
                                ...
                                <p class="mb-45">Start You'r Daily Shopping with <span class="text-brand">OragnicHaven
                                        </span></p>
                            ...
                            <img src="/assets/user/imgs/banner/banner-9.png" alt="newsletter" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container pt-15 pb-20">
                <div class="row">
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                            ...
                            <div class="logo mb-30">
                                <a href="index.html"
                                    style="font-size: 25px;font-weight: 900;color: #3BB77E;">OragnicHaven</a>
                                <p class="font-lg text-heading">Our Oragnic Store Makes Your Health Better </p>
                            </div>
                            <ul class="contact-infor">
                                <li><img src="/assets/user/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address:
                                    </strong> <span>5171 W Campbell Ave undefined Kent, Utah 53127 United States</span>
                                </li>
                                <li><img src="/assets/user/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Call
                                        Us:</strong><span>(+91) - 540-025-124553</span></li>
                                <li><img src="/assets/user/imgs/theme/icons/icon-email-2.svg"
                                        alt="" /><strong>Email:</strong><span>sale@Nest.com</span></li>
                                <li><img src="/assets/user/imgs/theme/icons/icon-clock.svg"
                    ...
                    <div class="footer-link-widget widget-install-app col wow animate__animated animate__fadeInUp"
                        ...
                        <img class="" src="/assets/user/imgs/theme/payment-method.png" alt="" />
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                    <div class="hotline d-lg-inline-flex mr-30">
                            <img src="/assets/user/imgs/theme/icons/phone-call.svg" alt="hotline" />
